...
return (
  ...
  <a onClick={openBottomsheet} className="image-container">
    <button className='button_openBottomsheet'><img  alt="Union" src="/img/cough.png" /></button>
    <button className='button_openBottomsheet'><img src="/img/bruise.png" alt="Button Icon" /></button>
    <button className='button_openBottomsheet'><img src="/img/indigestion.png" alt="Button Icon" /></button>
    <img className='button_openBottomsheet_plus' src="img/Group 173.png"></img>
  </a>
</div>
    ...
    <div className="Appp">
      ...
      snapPoints={({ minHeight, maxHeight }) => [
        ...
        <button
            ...
            className={`btn ${buttonColors['runny_nose']}`}
          >
          ...
          <button
            ...
            className={`btn ${buttonColors['cold']}`}
          >
          ...
          <button
            ...
            className={`btn ${buttonColors['headache']}`}
          >
          ...
          <button
            ...
            className={`btn ${buttonColors['covid_19']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['cough']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['wound']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['allergy']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['bruise']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['burn']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['indigestion']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['bowel_movement']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['eye_drops']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['toothache']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['muscle_pain']}`}
          >
        ...
        <button
            ...
            className={`btn ${buttonColors['insect']}`}
          >
